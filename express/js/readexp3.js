...
function sayItLoud() {
  ...
  if (validateWord === true) {
    var stepAudio = new Audio(
      "../../audios/female/insAudio" + stepNumber.toString() + ".mp3"
    );
    ...
    var stepAudio = new Audio("../../audios/female/error.mp3");
    stepAudio.play();
    currentStep.classList.add("isActive");
...
function stopInstructions(state) {
  if (state === "done") {
    var stepAudio = new Audio("../../audios/female/byebye.mp3");
